  ...
  <div>
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-img" v-for="(item, index) in carouselItems" :key="index" :class="{ 'carousel-item': true, active: index === activeIndex }">
          <!-- Your carousel item content goes here -->
          <img class="d-block w-100" :src="item.src" :alt="item.alt" />
        </div>
      </div>
      <!-- <a class="carousel-control-prev text-decoration-none" role="button" data-slide="prev" @click="prevSlide">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <i class="fa-solid fa-chevron-left fa-2xl"></i>
        <span class="sr-only">Previous</span>
      </a>
      <a class="carousel-control-next text-decoration-none" role="button" data-slide="next" @click="nextSlide">
